...
/// <summary>
/// The English Laya checkpoint (ModernBERT-large, 421M parameters, 512 tokens), packaged for NuGet.
///
/// <code>
...
/// </summary>
public static class LayaEnglish
{
    ...
    public static PackagedCheckpoint Checkpoint { get; } = new(
        typeof(LayaEnglish).Assembly, Name, PackagedCheckpoint.ResolveWeightsUrl("model.safetensors"));
