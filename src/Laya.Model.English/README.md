...
The English checkpoint for [Laya](https://github.com/theolivenbaum/laya) — the non-autoregressive System 1
decision engine for .NET. Trained for English; use `Laya.Model.Multilingual` for anything else.
...
| Parameters | 421M |
| Max tokens | 512 |
| Weights | 843 MB, downloaded from <https://models.curiosity.ai/laya/model.safetensors> |
...
`LayaEnglish.Prepare()` during deployment to warm the cache ahead of first use.
